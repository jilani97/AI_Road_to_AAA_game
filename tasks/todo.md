...
### Checkpoint 2
- [ ] Full state machine + progression + 3 characters working end-to-end. 10-min playtest with ≥2 near-miss moments documented per character × difficulty. **Remaining gates:** Task 13-UI (character-select + skill-tree + currency HUD + pickup hooks), Task 5 consumables shop (depends on 13-UI).
