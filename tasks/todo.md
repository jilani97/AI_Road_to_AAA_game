...
### Checkpoint 2
- [ ] Full state machine + progression + 3 characters working end-to-end. 10-min playtest with ≥2 near-miss moments documented per character × difficulty. **Remaining gates:** Task 5 consumables shop, playtest itself.
